...
public class BlogController {
    ...
    @GetMapping
    public Map<String, Object> showBlog(@RequestParam(value = "offset", defaultValue = "0") Integer offset, @RequestParam(value = "limit", defaultValue = "5") Integer limit, Map<String, Object> map) {
    ...
    @PostMapping
    public Map<String, Object> addBlog(@RequestBody Map<String, Object> condition) {
